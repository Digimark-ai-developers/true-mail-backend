...
# Note: You must have 'import dns.resolver' if using validate_email_mx_records

# Define known email providers for domain validation
KNOWN_EMAIL_PROVIDERS = {"gmail.com", "outlook.com", "yahoo.com", "icloud.com", "hotmail.com", "linkedin.com"}

...
from app.routes import auth, email, user, validator, subscription_stripe
from fastapi.middleware.cors import CORSMiddleware

app = FastAPI(title="True Mail API", description="Email verification and management API", version="1.0.0")
...
app.include_router(subscription_stripe.router, prefix="/stripe", tags=["Stripe"])
